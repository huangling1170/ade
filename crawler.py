...
def main(save_img_dir=r"E:\PycharmProjects\20211129my_单目标\bg_pic"):
    word = input("请输入关键词：")
        ...
        for img_url in re.findall('"objURL":"(.*?)",', result.text, re.S):
            ...
            try:
                if img_url not in url_list:
                    ...
                    img_path = os.path.join(img_dir, "cup2"+str(num) + '.jpg')
                    fp = open(img_path, 'wb')
...
if __name__ == '__main__':
    main(save_img_dir=r"E:\PycharmProjects\20211129my_单目标\bg_pic")
